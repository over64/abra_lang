...
public interface M2ParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link M2Parser#def}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDef(M2Parser.DefContext ctx);
	/**
	 * Visit a parse tree produced by {@link M2Parser#importEntry}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitImportEntry(M2Parser.ImportEntryContext ctx);
	/**
